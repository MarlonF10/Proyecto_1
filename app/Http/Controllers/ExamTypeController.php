...
class ExamTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('exam-type.index', compact('examTypes'))
    ...
    public function create()
    {
        ...
        return view('exam-type.create', compact('examType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('exam-type.index')
            ->with('success', 'Tipo de Examen Creada Correctamente.');
    }
    ...
    public function update(Request $request, ExamType $examType)
    {
        ...
        return redirect()->route('exam-type.index')
            ->with('success', 'Tipo de Examen Editado Correctamente');
    }
